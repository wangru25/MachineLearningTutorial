...
class CNNLayerNet(nn.ModuleList):
    def __init__(self, C_in, H0, H1, H2, K1, K2, P1, P2, D_out):
        """
        ...
        self.conv2 = nn.Conv2d(H1, H1, K2, bias=True)
...
def main():
    ...
    parser.add_argument('--test-batch-size', type=int, default=3767, metavar='N',
    ...
    H1 = 32 # c_out
    H2 = 128
    K1 = (3,3)  # 28 - 3 + 1 = 26 # 26/2 = 13 # H0 = C_out*13*13
    #K2 = (3,3)
    P1 = 2
    P2 = 2
    H0 = H1*5*5
    D_out = 10
    model = CNNLayerNet(C_in, H0, H1, H2, K1, K2, P1, P2, D_out).to(device)
    ...
    lr_adjust = optim.lr_scheduler.StepLR(optimizer, step_size = 60, gamma = 0.5, last_epoch = -1)
